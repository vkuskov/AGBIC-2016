...
namespace Entitas {
    public partial class Entity {
        public SeshFT.Gameplay.MoveSpeedComponent moveSpeed { get { return (SeshFT.Gameplay.MoveSpeedComponent)GetComponent(CoreComponentIds.MoveSpeed); } }

        public bool hasMoveSpeed { get { return HasComponent(CoreComponentIds.MoveSpeed); } }

        public Entity AddMoveSpeed(float newValue) {
            var component = CreateComponent<SeshFT.Gameplay.MoveSpeedComponent>(CoreComponentIds.MoveSpeed);
